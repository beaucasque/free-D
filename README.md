...
tools/       calibration et diagnostic
  vp-console.py      serveur web, 7 onglets — Guide, Appareils, Studio,
                     Objectifs, Test, Sortie, Objectif réel ; bandeau de
                     santé, surveillance et récupération automatiques
